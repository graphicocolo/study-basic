...
// ============================================================
// STEP 3: finally — 成功・失敗どちらでも実行される
// ============================================================
...
// ============================================================
// STEP 5: TODO — 自分で書いてみよう
// ============================================================

// TODO: 以下の関数を完成させてください
// - https://jsonplaceholder.typicode.com/users/1 からデータを取得する
// - response.ok でHTTPエラーをチェックする
// - 成功したら data.name と data.email を console.log する
// - エラーが起きたら console.error でメッセージを出力する
// - finally で "処理完了" を console.log する
